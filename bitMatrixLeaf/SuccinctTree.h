...
const int EMPTY = 0;
// for the Bit version I need to do some new ones for the 8x8 idea
const int LEAF_DIM = 8;
constexpr int LEAF_MUM = 2 * LEAF_DIM;
constexpr int LEAF_SIZE = LEAF_DIM * LEAF_DIM;
